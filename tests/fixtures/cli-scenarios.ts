...
export const languageTestData = {
  ...
  elixir: {
    ...
    invalidContent: 'defmodule Test do\n  def hello(x) when is_integer(x) do\n    x + "world"\n  end\nend',
    validContent: 'defmodule Test do\n  def hello(x) when is_binary(x) do\n    x <> " world"\n  end\nend',
    name: 'Elixir'
  },
  terraform: {
    ...
    validContent: 'resource "aws_instance" "example" {\n  instance_type = "t2.micro"\n  ami = "ami-12345678"\n}',
    name: 'Terraform'
  }
};
